...
#推送信息
def send_message(to_user, access_token, city_name, weather, max_temperature, min_temperature, pipi, lizhi, quality, tips, note_en, note_ch, health_tip, lucky_):
...
if __name__ == "__main__":
    ...
    #星座运势
    lucky_ = lucky()
    print(city, weather, max_temperature, min_temperature, pipi, lizhi, quality, tips, note_en,
                 note_ch, health_tip, lucky_)

    # 公众号推送消息
    for user in users:
        send_message(user, accessToken, city, weather, max_temperature, min_temperature, pipi, lizhi, quality, tips, note_en, note_ch, health_tip, lucky_)
    import time
    time_duration = 3.5
